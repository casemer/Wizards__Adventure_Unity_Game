...
public class GiantEnemyAI : MonoBehaviour {
    ...
    void Die()
    {
        ...
        Destroy(gameObject);
        GameObject impact = (GameObject)Instantiate(giantDeath, transform.position, transform.rotation);
        Destroy(impact, .25f);
    }
    ...
    void FixedUpdate()
    {
        ...
        if (target != null)
        {
            ...
            if (rb.velocity.x >= 0.4f && !facingRight)
            {
                t.Rotate(0f, 180f, 0f);
