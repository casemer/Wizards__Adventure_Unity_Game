...
public class BrothEnd : MonoBehaviour {
    ...
    void Start()
    {
        BrothTrigger dialogueTrigger = FindObjectOfType<BrothTrigger>();
    ...
    void Update()
    {
        ...
        if (nameText.text == "Broth")
        {
            nameText.color = new Color32(246, 212, 208, 255);
        }
    }

    public void StartDialogue(Dialogue dialogue)
    {
        PlayerPrefs.SetInt("GodBoss", 1);
        Cursor.visible = true;
