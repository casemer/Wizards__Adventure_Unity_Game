...
public class DialogueManagerGodNoOptions : MonoBehaviour
{
    ...
    void Start()
    {
        DialogueTriggerNoOptionsGod dialogueTrigger = FindObjectOfType<DialogueTriggerNoOptionsGod>();
    ...
    void Update()
    {
        ...
        if (nameText.text == "God")
        {
            nameText.color = new Color32(0, 0, 0, 0);
        }
