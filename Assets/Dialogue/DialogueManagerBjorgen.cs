...
public class DialogueManagerBjorgen : MonoBehaviour
{
    ...
    void Start()
    {
        DialogueTriggerBjorgen dialogueTrigger = FindObjectOfType<DialogueTriggerBjorgen>();
